        ...
        <div className="max-w-4xl mx-auto pt-10 px-6 pb-24 text-stone-300 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none -z-10">
                <video
                    ...
                    muted
                    playsInline
                    className="w-full h-full object-cover opacity-30 fixed top-0 left-0 h-screen"
                >
                    <source src={videoBg} type="video/mp4" />
                </video>
                <div className="absolute inset-0 bg-stone-900/80 fixed top-0 left-0 h-screen"></div>
            </div>
